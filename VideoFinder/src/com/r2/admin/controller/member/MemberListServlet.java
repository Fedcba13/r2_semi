...
public class MemberListServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		if (pageNo == 1) {
			...
			pageBar += "<li class='page-item'><a class='page-link' href='" + request.getContextPath() + "/admin/member/memberList?cPage=" + (pageNo - 1)
		...
		while (pageNo <= pageEnd && pageNo <= totalPage) {
			if (pageNo == cPage) {
				...
				pageBar += "<li class='page-item'><a class='page-link' href='" + request.getContextPath() + "/admin/member/memberList?cPage=" + (pageNo)

...
public class FAQListServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if (pageNo == 1) {
			...
			pageBar += "<li class='page-item'><a class='page-link' href='" + request.getContextPath() + "/admin/fAQ/fAQList?cPage=" + (pageNo - 1)
		...
		while (pageNo <= pageEnd && pageNo <= totalPage) {
			if (pageNo == cPage) {
				...
				pageBar += "<li class='page-item'><a class='page-link' href='" + request.getContextPath() + "/admin/fAQ/fAQList?cPage=" + (pageNo)
